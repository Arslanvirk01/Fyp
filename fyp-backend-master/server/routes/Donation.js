...
// var donationDate = currentdate.getDate() + "/"
//                 + (currentdate.getMonth()+1)  + "/" 
//                 + currentdate.getFullYear();
//            console.log("Data is: ",donationDate)
    console.log(_id);
    if (donorData) {
        const did = _id;
        const {donorName, medname, mg, quantity, expiryDate } = req.body;
        ...
        Donation.findOne({did,medname,mg}, (err, donation) => {
            ...
            if (donation) {
                        ...
                        if (err) {
                            ...
                            Medicine.findOne({ medname, mg }, (err, medicine) => {
                                ...
                                //res.status(400).json({message : {msgBody : "Medicie is already present", msgError: true}});
                                    ...
                                    const newMedicine = new Medicine({did,donorName, medname, mg, quantity, expiryDate,donationDate});
                ...
                const newDonation = new Donation({did,donorName, medname, mg, quantity, expiryDate,donationDate});
